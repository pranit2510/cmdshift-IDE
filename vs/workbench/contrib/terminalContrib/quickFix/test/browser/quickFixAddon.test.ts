...
suite('QuickFixAddon', () => {
	...
	setup(async () => {
		...
		labelService = instantiationService.stub(ILabelService, {} as Partial<ILabelService>) as any;
		...
		openerService = instantiationService.stub(IOpenerService, {} as Partial<IOpenerService>) as any;
